...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('BOARD_INVITE', 'CARD_ASSIGNED', 'CARD_MOVED', 'COMMENT_ADDED', 'MEMBER_JOINED', 'BOARD_UPDATED');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CARD_CREATED', 'CARD_MOVED', 'CARD_UPDATED', 'CARD_DELETED', 'CARD_ASSIGNED', 'CARD_UNASSIGNED', 'COMMENT_ADDED', 'COMMENT_DELETED', 'LIST_CREATED', 'LIST_RENAMED', 'LIST_DELETED', 'MEMBER_INVITED', 'MEMBER_JOINED', 'MEMBER_REMOVED', 'BOARD_UPDATED');
...
-- AddForeignKey
ALTER TABLE "BoardInvite" ADD CONSTRAINT "BoardInvite_invitedByUserId_fkey" FOREIGN KEY ("invitedByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_relatedCardId_fkey" FOREIGN KEY ("relatedCardId") REFERENCES "Card"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_relatedInviteId_fkey" FOREIGN KEY ("relatedInviteId") REFERENCES "BoardInvite"("id") ON DELETE SET NULL ON UPDATE CASCADE;
